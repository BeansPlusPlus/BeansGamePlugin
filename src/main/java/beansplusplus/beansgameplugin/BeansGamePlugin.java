...
public class BeansGamePlugin extends JavaPlugin {
  public void registerGame(InputStream configInputStream, GameSupplier gameSupplier) {
    ...
    GameCommandExecutor gameCommandExecutor = new GameCommandExecutor(configuration, gameSupplier);
